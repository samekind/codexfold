...
| Task 15: remaining platform and retention gates | Partial | Current macOS contracts, real-client acceptance, and controlled in-flight host interruption; real Linux FUSE3 operation, crash, performance, backing policy, and systemd lifecycle; Windows WinFsp/SCM cross-compile | Retention period, Linux client/upgrade/rollback gates, and all real Windows gates remain |
